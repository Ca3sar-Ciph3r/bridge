          ...
          <Card padding={28} style={{ width: "100%", boxShadow: "var(--shadow-3)", borderRadius: 16 }}>
            ...
            <Field label="Work email" error={error}>
              <Input
                ...
                type="email"
                prefix={<Icon name="mail" size={15}/>}
                error={!!error}
              />
            </Field>
            <div style={{ marginTop: 16 }}>
              <Button variant="accent" full size="lg" iconRight="arrow_right" onClick={handleSendLink} loading={loading}>
                Send magic link
              </Button>
            </div>
